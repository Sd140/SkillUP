...
app.get('/mycourse',auth.isLogin,(req,res)=>{
  ...
  const mycourse = Register.find({username:user.username})
  res.render("mycourse",{buttonname:user.firstname,mycourse:mycourse})
})
...
router.get('/:id',async(req,res)=>{
  const course_to_display = req.params.id
  const data = await Course.findOne({course_name:course_to_display})
  res.render("course-single",{data:data})
})
...
// enroll
// app.post('/course-single',async(req,res)=>{
//   res.render("index")
// })
